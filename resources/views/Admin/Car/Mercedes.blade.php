...
@include('Admin.site.sidebar')
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
     ...
     foreach ($MercedesData as $key => $manage_hotel) {
  $var++;
      ?>
        <tr>
      <td> <?php echo $var;  ?> </td>
      ...
      <td> <?php echo $manage_hotel->fname ?> </td>
      <td> <?php echo $manage_hotel->lanme  ?> </td>
      ...
      <td> <?php echo $manage_hotel->dest  ?> </td>
                      ...
                      <td>
  <a href="<?php echo route('admin.MercedesView',['pay_id'=>$manage_hotel->pay_id])?>" class="btn btn-primary btn-xs">View Detail</a>
    </td>
