...
@include('Admin.site.sidebar')
   ...
   <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Dashboard (Add Car)</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
 ...
 @endif
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
             <form enctype="multipart/form-data" action="{{route('admin.AddLimousine')}}" 
      ...
      {{csrf_field()}}
        ...
        <!--                  <div class="row">
             ...
             <lebel> Car transmition</lebel>
                  ...
                  <div class="col-md-6">
                           <div class="form-group">
                <input type="text" class="form-control" name="seat" placeholder="No. of Seats" required="true">
                     <div class="error" id="nameErr"></div>
                  </div>
                  ...
                  <input type="text" class="form-control" name="car_number" placeholder="Car Number" required="true">
                  ...
                  <input type="text" class="form-control" name="price" placeholder="Car price" required="true">
